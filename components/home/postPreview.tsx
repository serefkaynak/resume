...
import {MdMoving, MdNavigateNext, MdNorthEast} from "react-icons/md";
...
export default function PostPreview(props: PostPreviewProps) {
    const {post} = props
    return (
        <div className="p-4 m-2 rounded-lg text-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-800 hover:bg-zinc-100"
            ...
            <h3 className="font-semibold py-1 my-2 dark:text-zinc-100 text-black"
